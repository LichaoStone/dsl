...
<h3><i class="fa fa-star"></i> Icon Title</h3>
...
<h3><i class="fa fa-check-empty"></i> Plain portlet</h3>
...
<ul class="portlet-tools pull-right">
	<li><a href="javascript:;" class="btn btn-sm btn-icon"> <i
...
<ul class="portlet-tools pull-right">
	...
	<li><span class="label label-primary">Label Right Here</span></li>
</ul>
...
<ul class="portlet-tools pull-right">
	<li>
	<div class="btn-group">
	<button type="button" class="btn btn-sm btn-icon dropdown-toggle"
...
<ul class="portlet-tools pull-right">
	...
	<ul class="nav nav-pills">
		<li class="active"><a
			href="http://preview.jumpstartthemes.com/canvas-admin/ui-portlets.html#tab1"
			data-toggle="tab">Tab #1</a></li>
		<li><a
			href="http://preview.jumpstartthemes.com/canvas-admin/ui-portlets.html#tab2"
...
<ul class="portlet-tools pull-right">
	...
	<div class="progress-bar progress-bar-info" role="progressbar"
		...
		style="width: 67%"><span class="sr-only">67% Complete
	(success)</span></div>
	</div>
	</li>
</ul>
...
<ul class="portlet-tools pull-right">
	<li><span class="badge">13</span></li>
</ul>
