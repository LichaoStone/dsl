...
<button id="count" class="btn btn-primary" type="button">统计选中行</button>
<button id="delete" class="btn btn-primary" type="button">删除行</button>
<button id="add" class="btn btn-primary" type="button">增加行</button>
