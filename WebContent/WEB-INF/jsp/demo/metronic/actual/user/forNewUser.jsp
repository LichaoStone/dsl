...
<!-- 校验插件 -->
<lambo:script path="global/plugins/jquery-validation/js/jquery.validate.js" />
<!-- 信息提示-->
		...
		$('#user-form').validate({
             rules: {
             	USERID: {
                     minlength: 2,
                     required: true,
                     remote:"${ctx}/demo/actual/user/checkUserIdRepeat"
                 },
                 USERNAME: {
                     required: true,
                     minlength: 2
...
<body>
	...
	<div class="row margin-top-20">
		<div class="col-md-12">
			<div class="portlet light bordered portlet-fit portlet-form">
				<div class="portlet-title">
					<div class="caption font-dark">
						<i class="icon-settings font-dark"></i>
						<span class="caption-subject bold">用户信息维护</span>
					</div>
					<button id="goback" class="btn btn-default pull-right" type="button">返回</button>
				</div>
				<div class="portlet-body">
					<form action="${ctx}/demo/actual/user/saveNewUser" id="user-form" class="form-horizontal" method="post">
						<div class="form-body">
