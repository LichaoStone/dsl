...
<html>
<head>
<title>Solid portlets</title>
</head>
<body>
<!-- BEGIN PAGE TITLE-->
<h3 class="page-title"> Solid Portlets
    <small>solid portlet samples</small>
</h3>
<!-- END PAGE TITLE-->
<!-- END PAGE HEADER-->
        ...
        <div class="portlet light bordered">
            <div class="portlet-title">
                <div class="caption">
                    ...
                    <span class="caption-subject bold font-blue-hoki uppercase"> Quick Search </span>
                    <span class="caption-helper">more samples...</span>
                </div>
                <div class="actions">
        ...
        <div class="portlet light bg-inverse">
            <div class="portlet-title">
                <div class="caption">
                    ...
                    <span class="caption-subject bold font-purple-studio uppercase"> Pagination </span>
                </div>
