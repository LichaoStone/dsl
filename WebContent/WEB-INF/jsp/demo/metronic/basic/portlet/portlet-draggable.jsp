...
<html>
<head>
<title>Draggable portlets</title>
</head>
<body>
<!-- BEGIN PAGE TITLE-->
<h3 class="page-title"> 可拖拽的 Portlets
    <small> 可拖拽的 portlet 示例</small>
</h3>
<!-- END PAGE TITLE-->
<!-- END PAGE HEADER-->
<!-- BEGIN PAGE BANNER-->
<div class="row">
	<div class="col-md-12">
		<div class="note note-success note-bordered">
			<p>
				用途：使用jQueryUI Sortable Plugin使portlets可拖拽，你可以用jQueryUI Sortable API在后台存储portlet的位置
			</p>
			<br>
			<p>
		    	插件的css与js:<br>
		    	<a target="_blank" href = "/theme/assets/global/plugins/jquery-ui/jquery-ui.min.js">
							global/plugins/jquery-ui/jquery-ui.min.js
				</a><br>
			</p><br>
			<p>
				本demo页面的js:<br>
				<a target="_blank" href = "/theme/assets/pages/scripts/portlet-draggable.js">
							pages/scripts/portlet-draggable.js
				</a><br>
		    </p><br>
		     <p> 更多资料：
		        <a href="http://jqueryui.com/sortable/#portlets" target="_blank">jQueryUI Sortable Plugin's home</a>
		    </p>
		</div>
	</div>
</div>
...
<lambo:script path="global/plugins/jquery-ui/jquery-ui.min.js,
					pages/scripts/portlet-draggable.js"/>
</body>