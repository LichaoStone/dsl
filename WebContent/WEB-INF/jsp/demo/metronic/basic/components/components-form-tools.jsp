...
<div class="row">
	<div class="col-md-12">
		<div class="note note-success note-bordered">
			<p>
				用途：表单相关工具包，包括：验证码、校验、textarea、富文本框等
			</p>
			<br>
			<p>
		    	插件的css与js:<br>
		    	<a target="_blank" href = "/theme/assets/global/plugins/ckeditor/ckeditor.js">
					global/plugins/ckeditor/ckeditor.js
				</a><br>
				<a target="_blank" href = "/theme/assets/global/plugins/bootstrap-pwstrength/pwstrength-bootstrap.min.js">
					global/plugins/bootstrap-pwstrength/pwstrength-bootstrap.min.js
				</a><br>
				<a target="_blank" href = "/theme/assets/global/plugins/autosize/autosize.min.js">
					global/plugins/autosize/autosize.min.js
				</a><br>
				<a target="_blank" href = "/theme/assets/global/plugins/bootstrap-maxlength/bootstrap-maxlength.js">
					global/plugins/bootstrap-maxlength/bootstrap-maxlength.js
				</a><br>
			</p><br>
			<p>
				本demo页面的js:<br>
				<a target="_blank" href = "/theme/assets/pages/scripts/components-form-tools.js">
...
<lambo:script path="global/plugins/ckeditor/ckeditor.js,
					global/plugins/bootstrap-pwstrength/pwstrength-bootstrap.min.js,
					global/plugins/autosize/autosize.min.js,
					global/plugins/bootstrap-maxlength/bootstrap-maxlength.js,
					pages/scripts/components-form-tools.js" />
