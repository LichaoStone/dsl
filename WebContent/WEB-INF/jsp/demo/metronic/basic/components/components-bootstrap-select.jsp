...
<body>
<lambo:link path="global/plugins/bootstrap-select/css/bootstrap-select.min.css" />
<!-- BEGIN PAGE TITLE-->
<h3 class="page-title"> Bootstrap下拉控件
...
<div class="row">
	<div class="col-md-12">
		<div class="note note-success note-bordered">
			...
			<p>
				本demo页面的js:<br>
				<a href="/theme/assets/pages/scripts/components-bootstrap-select.js" target="_blank">
					pages/scripts/components-bootstrap-select.js
				</a><br>
		    </p><br>
		    <p> 更多资料：
		        <a href="http://silviomoreto.github.io/bootstrap-select/" target="_blank">官方文档</a>
		    </p><br>
		</div>
	</div>
</div>
...
<lambo:script path="global/plugins/bootstrap-select/js/bootstrap-select.min.js,
