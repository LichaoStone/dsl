...
<html>
<head>
<title>Elements cards</title>
</head>
<body>
<!-- BEGIN PAGE TITLE-->
<h3 class="page-title"> User Cards Elements
                        ...
                        <div class="col-lg-3 col-md-4 col-sm-6 col-xs-12">
                            <div class="mt-card-item">
                                <div class="mt-card-avatar mt-overlay-1">
                                    <img src="/theme/assets/pages/img/avatars/team1.jpg" />
                        ...
                        <div class="col-lg-3 col-md-4 col-sm-6 col-xs-12">
                            <div class="mt-card-item">
                                <div class="mt-card-avatar mt-overlay-1 mt-scroll-down">
                                    <img src="/theme/assets/pages/img/avatars/team2.jpg" />
                        ...
                        <div class="col-lg-3 col-md-4 col-sm-6 col-xs-12">
                            <div class="mt-card-item">
                                <div class="mt-card-avatar mt-overlay-1 mt-scroll-up">
                                    <img src="/theme/assets/pages/img/avatars/team3.jpg" />
                                    <div class="mt-overlay">
                                        <ul class="mt-info">
                                            <li>
                                                <a class="btn default btn-outline" href="javascript:;">
                        ...
                        <div class="col-lg-3 col-md-4 col-sm-6 col-xs-12">
                            <div class="mt-card-item">
                                <div class="mt-card-avatar mt-overlay-1 mt-scroll-left">
                                    <img src="/theme/assets/pages/img/avatars/team4.jpg" />
                                    <div class="mt-overlay">
                                        <ul class="mt-info">
                                            <li>
                                                <a class="btn default btn-outline" href="javascript:;">
                ...
                <div class="mt-element-card mt-card-round mt-element-overlay">
                    <div class="row">
                        <div class="col-lg-3 col-md-4 col-sm-6 col-xs-12">
                            <div class="mt-card-item">
                                <div class="mt-card-avatar mt-overlay-1">
                                    <img src="/theme/assets/pages/img/avatars/team5.jpg" />
                                    <div class="mt-overlay">
                                        <ul class="mt-info">
                                            <li>
                                                <a class="btn default btn-outline" href="javascript:;">
                        ...
                        <div class="col-lg-3 col-md-4 col-sm-6 col-xs-12">
                            <div class="mt-card-item">
                                <div class="mt-card-avatar mt-overlay-1 mt-scroll-down">
                                    <img src="/theme/assets/pages/img/avatars/team6.jpg" />
                                    <div class="mt-overlay mt-top">
                                        <ul class="mt-info">
                                            <li>
                                                <a class="btn default btn-outline" href="javascript:;">
                        ...
                        <div class="col-lg-3 col-md-4 col-sm-6 col-xs-12">
                            <div class="mt-card-item">
                                <div class="mt-card-avatar mt-overlay-1 mt-scroll-up">
                                    <img src="/theme/assets/pages/img/avatars/team7.jpg" />
                                    <div class="mt-overlay">
                                        <ul class="mt-info">
                                            <li>
                                                <a class="btn default btn-outline" href="javascript:;">
                        ...
                        <div class="col-lg-3 col-md-4 col-sm-6 col-xs-12">
                            <div class="mt-card-item">
                                <div class="mt-card-avatar mt-overlay-1 mt-scroll-left">
                                    <img src="/theme/assets/pages/img/avatars/team8.jpg" />
                                    <div class="mt-overlay">
                                        <ul class="mt-info">
                                            <li>
                                                <a class="btn default btn-outline" href="javascript:;">
                                ...
                                <div class="mt-card-avatar mt-overlay-4">
                                    ...
                                    <div class="mt-overlay">
                                        ...
                                        <div class="mt-info font-white">
                                            <div class="mt-card-content">
                                                <p class="mt-card-desc font-white">Managing Director</p>
                                                <div class="mt-card-social">
                                                    <ul>
                                                        <li>
                            ...
                            <div class="mt-card-item">
                                <div class="mt-card-avatar mt-overlay-4">
                                    ...
                                    <div class="mt-overlay">
                                        ...
                                        <div class="mt-info font-white">
                                            <div class="mt-card-content">
                                                <p class="mt-card-desc font-white">Finance Director</p>
                                                <div class="mt-card-social">
                                                    <ul>
                                                        <li>
                                                            <a class="mt-card-btn" href="javascript:;">
                            ...
                            <div class="mt-card-item">
                                <div class="mt-card-avatar mt-overlay-4">
                                    ...
                                    <div class="mt-overlay">
                                        ...
                                        <div class="mt-info font-white">
                                            <div class="mt-card-content">
                                                <p class="mt-card-desc font-white">Creative Director</p>
                                                <div class="mt-card-social">
                                                    <ul>
                                                        <li>
                                                            <a class="mt-card-btn" href="javascript:;">
                            ...
                            <div class="mt-card-item">
                                <div class="mt-card-avatar mt-overlay-4">
                                    ...
                                    <div class="mt-overlay">
                                        ...
                                        <div class="mt-info font-white">
                                            <div class="mt-card-content">
                                                <p class="mt-card-desc font-white">HR Director</p>
                                                <div class="mt-card-social">
                                                    <ul>
                                                        <li>
                                                            <a class="mt-card-btn" href="javascript:;">
