...
<body>
<lambo:link path="global/plugins/socicon/socicon.css" />
<!-- BEGIN PAGE TITLE-->
<h3 class="page-title"> 社交 Icons
    <small>常用社交图标</small>
</h3>
<!-- END PAGE TITLE-->
<!-- END PAGE HEADER-->
...
<div class="row">
	<div class="col-md-12">
		<div class="note note-success note-bordered">
			...
			<p>
		    	插件的css:<br>
		    	<a taregt="_blank" href = "/theme/assets/global/plugins/socicon/socicon.css">
		    		global/plugins/socicon/socicon.css
		    	</a>
			</p>
		</div>
	</div>
...
<div class="portlet light portlet-fit bordered">
    ...
    <div class="portlet-body">
        ...
        <h3>Solid Icons</h3>
        <div class="socicons">
            <a href="#" class="socicon-btn socicon-btn-circle socicon-solid bg-green font-white bg-hover-grey-salsa socicon-twitter tooltips" data-original-title="Twitter"></a>
            <a href="#" class="socicon-btn socicon-btn-circle socicon-solid bg-green font-white bg-hover-grey-salsa socicon-facebook tooltips" data-original-title="Facebook"></a>
            <a href="#" class="socicon-btn socicon-btn-circle socicon-solid bg-blue font-white bg-hover-grey-salsa socicon-google tooltips" data-original-title="Google"></a>
            ...
            <a href="#" class="socicon-btn socicon-btn-circle socicon-solid bg-red font-white bg-hover-grey-salsa socicon-foursquare tooltips" data-original-title="Foursquare"></a>
            ...
            <a href="#" class="socicon-btn socicon-btn-circle socicon-solid bg-yellow font-white bg-hover-grey-salsa socicon-feedburner tooltips" data-original-title="Feedburner"></a>
            ...
            <a href="#" class="socicon-btn socicon-btn-circle socicon-solid bg-red font-white bg-hover-grey-salsa socicon-xing tooltips" data-original-title="Xing"></a>
            <a href="#" class="socicon-btn socicon-btn-circle socicon-solid bg-green font-white bg-hover-grey-salsa socicon-myspace tooltips" data-original-title="Myspace"></a>
            <a href="#" class="socicon-btn socicon-btn-circle socicon-solid bg-red font-white bg-hover-grey-salsa socicon-soundcloud tooltips" data-original-title="Soundcloud"></a>
            <a href="#" class="socicon-btn socicon-btn-circle socicon-solid bg-green font-white bg-hover-grey-salsa socicon-spotify tooltips" data-original-title="Spotify"></a>
            ...
            <a href="#" class="socicon-btn socicon-btn-circle socicon-solid bg-yellow font-white bg-hover-grey-salsa socicon-lastfm tooltips" data-original-title="Lastfm"></a>
            ...
            <a href="#" class="socicon-btn socicon-btn-circle socicon-solid bg-yellow font-white bg-hover-grey-salsa socicon-dailymotion tooltips" data-original-title="Dailymotion"></a>
            ...
            <a href="#" class="socicon-btn socicon-btn-circle socicon-solid bg-blue font-white bg-hover-grey-salsa socicon-flickr tooltips" data-original-title="Flickr"></a>
            <a href="#" class="socicon-btn socicon-btn-circle socicon-solid bg-dark font-white bg-hover-grey-salsa socicon-500px tooltips" data-original-title="500px"></a>
            <a href="#" class="socicon-btn socicon-btn-circle socicon-solid bg-dark font-white bg-hover-grey-salsa socicon-instagram tooltips" data-original-title="Instagram"></a>
            <a href="#" class="socicon-btn socicon-btn-circle socicon-solid bg-dark font-white bg-hover-grey-salsa socicon-wordpress tooltips" data-original-title="Wordpress"></a>
            <a href="#" class="socicon-btn socicon-btn-circle socicon-solid bg-green font-white bg-hover-grey-salsa socicon-tumblr tooltips" data-original-title="Tumblr"></a>
            <a href="#" class="socicon-btn socicon-btn-circle socicon-solid bg-yellow font-white bg-hover-grey-salsa socicon-blogger tooltips" data-original-title="Blogger"></a>
            ...
            <a href="#" class="socicon-btn socicon-btn-circle socicon-solid bg-green font-white bg-hover-grey-salsa socicon-reddit tooltips" data-original-title="Reddit"></a>
            ...
            <a href="#" class="socicon-btn socicon-btn-circle socicon-solid bg-green font-white bg-hover-grey-salsa socicon-digg tooltips" data-original-title="Digg"></a>
            <a href="#" class="socicon-btn socicon-btn-circle socicon-solid bg-dark font-white bg-hover-grey-salsa socicon-envato tooltips" data-original-title="Envato"></a>
            ...
            <a href="#" class="socicon-btn socicon-btn-circle socicon-solid bg-red font-white bg-hover-grey-salsa socicon-deviantart tooltips" data-original-title="Deviantart"></a>
            <a href="#" class="socicon-btn socicon-btn-circle socicon-solid bg-blue font-white bg-hover-grey-salsa socicon-forrst tooltips" data-original-title="Forrst"></a>
            <a href="#" class="socicon-btn socicon-btn-circle socicon-solid bg-red font-white bg-hover-grey-salsa socicon-playstore tooltips" data-original-title="Playstore"></a>
            <a href="#" class="socicon-btn socicon-btn-circle socicon-solid bg-red font-white bg-hover-grey-salsa socicon-zerply tooltips" data-original-title="Zerply"></a>
            ...
            <a href="#" class="socicon-btn socicon-btn-circle socicon-solid bg-yellow font-white bg-hover-grey-salsa socicon-flattr tooltips" data-original-title="Flattr"></a>
            <a href="#" class="socicon-btn socicon-btn-circle socicon-solid bg-red font-white bg-hover-grey-salsa socicon-github tooltips" data-original-title="Github"></a>
            <a href="#" class="socicon-btn socicon-btn-circle socicon-solid bg-dark font-white bg-hover-grey-salsa socicon-chimein tooltips" data-original-title="Chimein"></a>
            <a href="#" class="socicon-btn socicon-btn-circle socicon-solid bg-red font-white bg-hover-grey-salsa socicon-friendfeed tooltips" data-original-title="Friendfeed"></a>
            <a href="#" class="socicon-btn socicon-btn-circle socicon-solid bg-green font-white bg-hover-grey-salsa socicon-newsvine tooltips" data-original-title="Newsvine"></a>
            ...
            <a href="#" class="socicon-btn socicon-btn-circle socicon-solid bg-blue font-white bg-hover-grey-salsa socicon-bebo tooltips" data-original-title="Bebo"></a>
            <a href="#" class="socicon-btn socicon-btn-circle socicon-solid bg-yellow font-white bg-hover-grey-salsa socicon-zynga tooltips" data-original-title="Zynga"></a>
            <a href="#" class="socicon-btn socicon-btn-circle socicon-solid bg-red font-white bg-hover-grey-salsa socicon-steam tooltips" data-original-title="Steam"></a>
            <a href="#" class="socicon-btn socicon-btn-circle socicon-solid bg-green font-white bg-hover-grey-salsa socicon-xbox tooltips" data-original-title="Xbox"></a>
            ...
            <a href="#" class="socicon-btn socicon-btn-circle socicon-solid bg-red font-white bg-hover-grey-salsa socicon-outlook tooltips" data-original-title="Outlook"></a>
            <a href="#" class="socicon-btn socicon-btn-circle socicon-solid bg-blue font-white bg-hover-grey-salsa socicon-coderwall tooltips" data-original-title="Coderwall"></a>
            ...
            <a href="#" class="socicon-btn socicon-btn-circle socicon-solid bg-dark font-white bg-hover-grey-salsa socicon-appnet tooltips" data-original-title="Appnet"></a>
            <a href="#" class="socicon-btn socicon-btn-circle socicon-solid bg-blue font-white bg-hover-grey-salsa socicon-goodreads tooltips" data-original-title="Goodreads"></a>
            <a href="#" class="socicon-btn socicon-btn-circle socicon-solid bg-green font-white bg-hover-grey-salsa socicon-tripit tooltips" data-original-title="Tripit"></a>
            ...
            <a href="#" class="socicon-btn socicon-btn-circle socicon-solid bg-dark font-white bg-hover-grey-salsa socicon-rss tooltips" data-original-title="Rss"></a>
            <a href="#" class="socicon-btn socicon-btn-circle socicon-solid bg-blue font-white bg-hover-grey-salsa socicon-vkontakte tooltips" data-original-title="Vkontakte"></a>
            <a href="#" class="socicon-btn socicon-btn-circle socicon-solid bg-red font-white bg-hover-grey-salsa socicon-disqus tooltips" data-original-title="Disqus"></a>
            <a href="#" class="socicon-btn socicon-btn-circle socicon-solid bg-green font-white bg-hover-grey-salsa socicon-houzz tooltips" data-original-title="Houzz"></a>
            <a href="#" class="socicon-btn socicon-btn-circle socicon-solid bg-blue font-white bg-hover-grey-salsa socicon-mail tooltips" data-original-title="Mail"></a>
            ...
            <a href="#" class="socicon-btn socicon-btn-circle socicon-solid bg-red font-white bg-hover-grey-salsa socicon-playstation tooltips" data-original-title="Playstation"></a>
            <a href="#" class="socicon-btn socicon-btn-circle socicon-solid bg-blue font-white bg-hover-grey-salsa socicon-smugmug tooltips" data-original-title="Smugmug"></a>
            ...
            <a href="#" class="socicon-btn socicon-btn-circle socicon-solid bg-blue font-white bg-hover-grey-salsa socicon-triplej tooltips" data-original-title="Triplej"></a>
            <a href="#" class="socicon-btn socicon-btn-circle socicon-solid bg-dark font-white bg-hover-grey-salsa socicon-yammer tooltips" data-original-title="Yammer"></a>
            <a href="#" class="socicon-btn socicon-btn-circle socicon-solid bg-red font-white bg-hover-grey-salsa socicon-stackoverflow tooltips" data-original-title="Stackoverflow"></a>
            <a href="#" class="socicon-btn socicon-btn-circle socicon-solid bg-green font-white bg-hover-grey-salsa socicon-drupal tooltips" data-original-title="Drupal"></a>
            ...
            <a href="#" class="socicon-btn socicon-btn-circle socicon-solid bg-blue font-white bg-hover-grey-salsa socicon-android tooltips" data-original-title="Android"></a>
            <a href="#" class="socicon-btn socicon-btn-circle socicon-solid bg-dark font-white bg-hover-grey-salsa socicon-meetup tooltips" data-original-title="Meetup"></a>
            <a href="#" class="socicon-btn socicon-btn-circle socicon-solid bg-yellow font-white bg-hover-grey-salsa socicon-persona tooltips" data-original-title="Persona"></a>
        </div>
        <h3>Large Size</h3>
        <div class="socicons">
            <a href="#" class="socicon-btn socicon-btn-circle socicon-lg socicon-solid bg-blue bg-hover-grey-salsa font-white bg-hover-white socicon-twitter tooltips" data-original-title="Twitter"></a>
            <a href="#" class="socicon-btn socicon-btn-circle socicon-lg socicon-solid bg-green bg-hover-grey-salsa font-white bg-hover-white socicon-facebook tooltips" data-original-title="Facebook"></a>
            ...
            <a href="#" class="socicon-btn socicon-btn-circle socicon-lg socicon-solid bg-dark bg-hover-grey-salsa font-white bg-hover-white socicon-yahoo tooltips" data-original-title="Yahoo"></a>
            <a href="#" class="socicon-btn socicon-btn-circle socicon-lg socicon-solid bg-red bg-hover-grey-salsa font-white bg-hover-white socicon-skype tooltips" data-original-title="Skype"></a>
            <a href="#" class="socicon-btn socicon-btn-circle socicon-lg socicon-solid bg-dark bg-hover-grey-salsa font-white bg-hover-white socicon-yelp tooltips" data-original-title="Yelp"></a>
            <a href="#" class="socicon-btn socicon-btn-circle socicon-lg socicon-solid bg-yellow bg-hover-grey-salsa font-white bg-hover-white socicon-feedburner tooltips" data-original-title="Feedburner"></a>
            <a href="#" class="socicon-btn socicon-btn-circle socicon-lg socicon-solid bg-green bg-hover-grey-salsa font-white bg-hover-white socicon-linkedin tooltips" data-original-title="Linkedin"></a>
            <a href="#" class="socicon-btn socicon-btn-circle socicon-lg socicon-solid bg-blue bg-hover-grey-salsa font-white bg-hover-white socicon-viadeo tooltips" data-original-title="Viadeo"></a>
            ...
            <a href="#" class="socicon-btn socicon-btn-circle socicon-lg socicon-solid bg-blue bg-hover-grey-salsa font-white bg-hover-white socicon-myspace tooltips" data-original-title="Myspace"></a>
            <a href="#" class="socicon-btn socicon-btn-circle socicon-lg socicon-solid bg-yellow bg-hover-grey-salsa font-white bg-hover-white socicon-soundcloud tooltips" data-original-title="Soundcloud"></a>
            <a href="#" class="socicon-btn socicon-btn-circle socicon-lg socicon-solid bg-red bg-hover-grey-salsa font-white bg-hover-white socicon-spotify tooltips" data-original-title="Spotify"></a>
            <a href="#" class="socicon-btn socicon-btn-circle socicon-lg socicon-solid bg-blue bg-hover-grey-salsa font-white bg-hover-white socicon-grooveshark tooltips" data-original-title="Grooveshark"></a>
            <a href="#" class="socicon-btn socicon-btn-circle socicon-lg socicon-solid bg-green bg-hover-grey-salsa font-white bg-hover-white socicon-lastfm tooltips" data-original-title="Lastfm"></a>
            <a href="#" class="socicon-btn socicon-btn-circle socicon-lg socicon-solid bg-yellow bg-hover-grey-salsa font-white bg-hover-white socicon-youtube tooltips" data-original-title="Youtube"></a>
            <a href="#" class="socicon-btn socicon-btn-circle socicon-lg socicon-solid bg-yellow bg-hover-grey-salsa font-white bg-hover-white socicon-vimeo tooltips" data-original-title="Vimeo"></a>
            <a href="#" class="socicon-btn socicon-btn-circle socicon-lg socicon-solid bg-blue bg-hover-grey-salsa font-white bg-hover-white socicon-dailymotion tooltips" data-original-title="Dailymotion"></a>
            <a href="#" class="socicon-btn socicon-btn-circle socicon-lg socicon-solid bg-dark bg-hover-grey-salsa font-white bg-hover-white socicon-vine tooltips" data-original-title="Vine"></a>
            ...
            <a href="#" class="socicon-btn socicon-btn-circle socicon-lg socicon-solid bg-blue bg-hover-grey-salsa font-white bg-hover-white socicon-500px tooltips" data-original-title="500px"></a>
            <a href="#" class="socicon-btn socicon-btn-circle socicon-lg socicon-solid bg-red bg-hover-grey-salsa font-white bg-hover-white socicon-instagram tooltips" data-original-title="Instagram"></a>
            ...
            <a href="#" class="socicon-btn socicon-btn-circle socicon-lg socicon-solid bg-dark bg-hover-grey-salsa font-white bg-hover-white socicon-tumblr tooltips" data-original-title="Tumblr"></a>
            <a href="#" class="socicon-btn socicon-btn-circle socicon-lg socicon-solid bg-green bg-hover-grey-salsa font-white bg-hover-white socicon-blogger tooltips" data-original-title="Blogger"></a>
            <a href="#" class="socicon-btn socicon-btn-circle socicon-lg socicon-solid bg-green bg-hover-grey-salsa font-white bg-hover-white socicon-technorati tooltips" data-original-title="Technorati"></a>
            <a href="#" class="socicon-btn socicon-btn-circle socicon-lg socicon-solid bg-dark bg-hover-grey-salsa font-white bg-hover-white socicon-reddit tooltips" data-original-title="Reddit"></a>
            <a href="#" class="socicon-btn socicon-btn-circle socicon-lg socicon-solid bg-red bg-hover-grey-salsa font-white bg-hover-white socicon-dribbble tooltips" data-original-title="Dribbble"></a>
            ...
            <a href="#" class="socicon-btn socicon-btn-circle socicon-lg socicon-solid bg-dark bg-hover-grey-salsa font-white bg-hover-white socicon-envato tooltips" data-original-title="Envato"></a>
            <a href="#" class="socicon-btn socicon-btn-circle socicon-lg socicon-solid bg-red bg-hover-grey-salsa font-white bg-hover-white socicon-behance tooltips" data-original-title="Behance"></a>
            ...
            <a href="#" class="socicon-btn socicon-btn-circle socicon-lg socicon-solid bg-yellow bg-hover-grey-salsa font-white bg-hover-white socicon-deviantart tooltips" data-original-title="Deviantart"></a>
            <a href="#" class="socicon-btn socicon-btn-circle socicon-lg socicon-solid bg-yellow bg-hover-grey-salsa font-white bg-hover-white socicon-forrst tooltips" data-original-title="Forrst"></a>
            <a href="#" class="socicon-btn socicon-btn-circle socicon-lg socicon-solid bg-blue bg-hover-grey-salsa font-white bg-hover-white socicon-playstore tooltips" data-original-title="Playstore"></a>
            ...
            <a href="#" class="socicon-btn socicon-btn-circle socicon-lg socicon-solid bg-dark bg-hover-grey-salsa font-white bg-hover-white socicon-wikipedia tooltips" data-original-title="Wikipedia"></a>
            ...
            <a href="#" class="socicon-btn socicon-btn-circle socicon-lg socicon-solid bg-blue bg-hover-grey-salsa font-white bg-hover-white socicon-flattr tooltips" data-original-title="Flattr"></a>
            ...
            <a href="#" class="socicon-btn socicon-btn-circle socicon-lg socicon-solid bg-dark bg-hover-grey-salsa font-white bg-hover-white socicon-chimein tooltips" data-original-title="Chimein"></a>
            ...
            <a href="#" class="socicon-btn socicon-btn-circle socicon-lg socicon-solid bg-blue bg-hover-grey-salsa font-white bg-hover-white socicon-identica tooltips" data-original-title="Identica"></a>
            <a href="#" class="socicon-btn socicon-btn-circle socicon-lg socicon-solid bg-yellow bg-hover-grey-salsa font-white bg-hover-white socicon-bebo tooltips" data-original-title="Bebo"></a>
            ...
            <a href="#" class="socicon-btn socicon-btn-circle socicon-lg socicon-solid bg-blue bg-hover-grey-salsa font-white bg-hover-white socicon-steam tooltips" data-original-title="Steam"></a>
            <a href="#" class="socicon-btn socicon-btn-circle socicon-lg socicon-solid bg-blue bg-hover-grey-salsa font-white bg-hover-white socicon-xbox tooltips" data-original-title="Xbox"></a>
            ...
            <a href="#" class="socicon-btn socicon-btn-circle socicon-lg socicon-solid bg-dark bg-hover-grey-salsa font-white bg-hover-white socicon-outlook tooltips" data-original-title="Outlook"></a>
            <a href="#" class="socicon-btn socicon-btn-circle socicon-lg socicon-solid bg-yellow bg-hover-grey-salsa font-white bg-hover-white socicon-coderwall tooltips" data-original-title="Coderwall"></a>
            ...
            <a href="#" class="socicon-btn socicon-btn-circle socicon-lg socicon-solid bg-dark bg-hover-grey-salsa font-white bg-hover-white socicon-appnet tooltips" data-original-title="Appnet"></a>
            <a href="#" class="socicon-btn socicon-btn-circle socicon-lg socicon-solid bg-yellow bg-hover-grey-salsa font-white bg-hover-white socicon-goodreads tooltips" data-original-title="Goodreads"></a>
            <a href="#" class="socicon-btn socicon-btn-circle socicon-lg socicon-solid bg-blue bg-hover-grey-salsa font-white bg-hover-white socicon-tripit tooltips" data-original-title="Tripit"></a>
            <a href="#" class="socicon-btn socicon-btn-circle socicon-lg socicon-solid bg-blue bg-hover-grey-salsa font-white bg-hover-white socicon-lanyrd tooltips" data-original-title="Lanyrd"></a>
            <a href="#" class="socicon-btn socicon-btn-circle socicon-lg socicon-solid bg-green bg-hover-grey-salsa font-white bg-hover-white socicon-slideshare tooltips" data-original-title="Slideshare"></a>
            <a href="#" class="socicon-btn socicon-btn-circle socicon-lg socicon-solid bg-dark bg-hover-grey-salsa font-white bg-hover-white socicon-buffer tooltips" data-original-title="Buffer"></a>
            ...
            <a href="#" class="socicon-btn socicon-btn-circle socicon-lg socicon-solid bg-red bg-hover-grey-salsa font-white bg-hover-white socicon-disqus tooltips" data-original-title="Disqus"></a>
            ...
            <a href="#" class="socicon-btn socicon-btn-circle socicon-lg socicon-solid bg-yellow bg-hover-grey-salsa font-white bg-hover-white socicon-patreon tooltips" data-original-title="Patreon"></a>
            <a href="#" class="socicon-btn socicon-btn-circle socicon-lg socicon-solid bg-dark bg-hover-grey-salsa font-white bg-hover-white socicon-paypal tooltips" data-original-title="Paypal"></a>
            <a href="#" class="socicon-btn socicon-btn-circle socicon-lg socicon-solid bg-blue bg-hover-grey-salsa font-white bg-hover-white socicon-playstation tooltips" data-original-title="Playstation"></a>
            ...
            <a href="#" class="socicon-btn socicon-btn-circle socicon-lg socicon-solid bg-yellow bg-hover-grey-salsa font-white bg-hover-white socicon-triplej tooltips" data-original-title="Triplej"></a>
            <a href="#" class="socicon-btn socicon-btn-circle socicon-lg socicon-solid bg-blue bg-hover-grey-salsa font-white bg-hover-white socicon-yammer tooltips" data-original-title="Yammer"></a>
            ...
            <a href="#" class="socicon-btn socicon-btn-circle socicon-lg socicon-solid bg-blue bg-hover-grey-salsa font-white bg-hover-white socicon-odnoklassniki tooltips" data-original-title="Odnoklassniki"></a>
            <a href="#" class="socicon-btn socicon-btn-circle socicon-lg socicon-solid bg-dark bg-hover-grey-salsa font-white bg-hover-white socicon-android tooltips" data-original-title="Android"></a>
            <a href="#" class="socicon-btn socicon-btn-circle socicon-lg socicon-solid bg-green bg-hover-grey-salsa font-white bg-hover-white socicon-meetup tooltips" data-original-title="Meetup"></a>
            <a href="#" class="socicon-btn socicon-btn-circle socicon-lg socicon-solid bg-blue bg-hover-grey-salsa font-white bg-hover-white socicon-persona tooltips" data-original-title="Persona"></a>
        </div>
        <h3>Small Size</h3>
        <div class="socicons">
            ...
            <a href="#" class="socicon-btn socicon-btn-circle socicon-sm socicon-solid bg-blue bg-hover-grey-salsa font-white bg-hover-white socicon-google tooltips" data-original-title="Google"></a>
            <a href="#" class="socicon-btn socicon-btn-circle socicon-sm socicon-solid bg-red bg-hover-grey-salsa font-white bg-hover-white socicon-pinterest tooltips" data-original-title="Pinterest"></a>
            <a href="#" class="socicon-btn socicon-btn-circle socicon-sm socicon-solid bg-yellow bg-hover-grey-salsa font-white bg-hover-white socicon-foursquare tooltips" data-original-title="Foursquare"></a>
            ...
            <a href="#" class="socicon-btn socicon-btn-circle socicon-sm socicon-solid bg-blue bg-hover-grey-salsa font-white bg-hover-white socicon-feedburner tooltips" data-original-title="Feedburner"></a>
            <a href="#" class="socicon-btn socicon-btn-circle socicon-sm socicon-solid bg-red bg-hover-grey-salsa font-white bg-hover-white socicon-linkedin tooltips" data-original-title="Linkedin"></a>
            <a href="#" class="socicon-btn socicon-btn-circle socicon-sm socicon-solid bg-yellow bg-hover-grey-salsa font-white bg-hover-white socicon-viadeo tooltips" data-original-title="Viadeo"></a>
            <a href="#" class="socicon-btn socicon-btn-circle socicon-sm socicon-solid bg-yellow bg-hover-grey-salsa font-white bg-hover-white socicon-xing tooltips" data-original-title="Xing"></a>
            <a href="#" class="socicon-btn socicon-btn-circle socicon-sm socicon-solid bg-red bg-hover-grey-salsa font-white bg-hover-white socicon-myspace tooltips" data-original-title="Myspace"></a>
            ...
            <a href="#" class="socicon-btn socicon-btn-circle socicon-sm socicon-solid bg-dark bg-hover-grey-salsa font-white bg-hover-white socicon-spotify tooltips" data-original-title="Spotify"></a>
            ...
            <a href="#" class="socicon-btn socicon-btn-circle socicon-sm socicon-solid bg-blue bg-hover-grey-salsa font-white bg-hover-white socicon-youtube tooltips" data-original-title="Youtube"></a>
            <a href="#" class="socicon-btn socicon-btn-circle socicon-sm socicon-solid bg-red bg-hover-grey-salsa font-white bg-hover-white socicon-vimeo tooltips" data-original-title="Vimeo"></a>
            <a href="#" class="socicon-btn socicon-btn-circle socicon-sm socicon-solid bg-blue bg-hover-grey-salsa font-white bg-hover-white socicon-dailymotion tooltips" data-original-title="Dailymotion"></a>
            ...
            <a href="#" class="socicon-btn socicon-btn-circle socicon-sm socicon-solid bg-red bg-hover-grey-salsa font-white bg-hover-white socicon-flickr tooltips" data-original-title="Flickr"></a>
            ...
            <a href="#" class="socicon-btn socicon-btn-circle socicon-sm socicon-solid bg-red bg-hover-grey-salsa font-white bg-hover-white socicon-wordpress tooltips" data-original-title="Wordpress"></a>
            <a href="#" class="socicon-btn socicon-btn-circle socicon-sm socicon-solid bg-yellow bg-hover-grey-salsa font-white bg-hover-white socicon-tumblr tooltips" data-original-title="Tumblr"></a>
            <a href="#" class="socicon-btn socicon-btn-circle socicon-sm socicon-solid bg-green bg-hover-grey-salsa font-white bg-hover-white socicon-blogger tooltips" data-original-title="Blogger"></a>
            <a href="#" class="socicon-btn socicon-btn-circle socicon-sm socicon-solid bg-green bg-hover-grey-salsa font-white bg-hover-white socicon-technorati tooltips" data-original-title="Technorati"></a>
            ...
            <a href="#" class="socicon-btn socicon-btn-circle socicon-sm socicon-solid bg-yellow bg-hover-grey-salsa font-white bg-hover-white socicon-dribbble tooltips" data-original-title="Dribbble"></a>
            ...
            <a href="#" class="socicon-btn socicon-btn-circle socicon-sm socicon-solid bg-blue bg-hover-grey-salsa font-white bg-hover-white socicon-envato tooltips" data-original-title="Envato"></a>
            <a href="#" class="socicon-btn socicon-btn-circle socicon-sm socicon-solid bg-dark bg-hover-grey-salsa font-white bg-hover-white socicon-behance tooltips" data-original-title="Behance"></a>
            <a href="#" class="socicon-btn socicon-btn-circle socicon-sm socicon-solid bg-blue bg-hover-grey-salsa font-white bg-hover-white socicon-delicious tooltips" data-original-title="Delicious"></a>
            ...
            <a href="#" class="socicon-btn socicon-btn-circle socicon-sm socicon-solid bg-dark bg-hover-grey-salsa font-white bg-hover-white socicon-playstore tooltips" data-original-title="Playstore"></a>
            ...
            <a href="#" class="socicon-btn socicon-btn-circle socicon-sm socicon-solid bg-red bg-hover-grey-salsa font-white bg-hover-white socicon-wikipedia tooltips" data-original-title="Wikipedia"></a>
            <a href="#" class="socicon-btn socicon-btn-circle socicon-sm socicon-solid bg-green bg-hover-grey-salsa font-white bg-hover-white socicon-apple tooltips" data-original-title="Apple"></a>
            ...
            <a href="#" class="socicon-btn socicon-btn-circle socicon-sm socicon-solid bg-red bg-hover-grey-salsa font-white bg-hover-white socicon-github tooltips" data-original-title="Github"></a>
            ...
            <a href="#" class="socicon-btn socicon-btn-circle socicon-sm socicon-solid bg-red bg-hover-grey-salsa font-white bg-hover-white socicon-newsvine tooltips" data-original-title="Newsvine"></a>
            <a href="#" class="socicon-btn socicon-btn-circle socicon-sm socicon-solid bg-dark bg-hover-grey-salsa font-white bg-hover-white socicon-identica tooltips" data-original-title="Identica"></a>
            <a href="#" class="socicon-btn socicon-btn-circle socicon-sm socicon-solid bg-blue bg-hover-grey-salsa font-white bg-hover-white socicon-bebo tooltips" data-original-title="Bebo"></a>
            <a href="#" class="socicon-btn socicon-btn-circle socicon-sm socicon-solid bg-green bg-hover-grey-salsa font-white bg-hover-white socicon-zynga tooltips" data-original-title="Zynga"></a>
            <a href="#" class="socicon-btn socicon-btn-circle socicon-sm socicon-solid bg-red bg-hover-grey-salsa font-white bg-hover-white socicon-steam tooltips" data-original-title="Steam"></a>
            <a href="#" class="socicon-btn socicon-btn-circle socicon-sm socicon-solid bg-yellow bg-hover-grey-salsa font-white bg-hover-white socicon-xbox tooltips" data-original-title="Xbox"></a>
            <a href="#" class="socicon-btn socicon-btn-circle socicon-sm socicon-solid bg-green bg-hover-grey-salsa font-white bg-hover-white socicon-windows tooltips" data-original-title="Windows"></a>
            ...
            <a href="#" class="socicon-btn socicon-btn-circle socicon-sm socicon-solid bg-red bg-hover-grey-salsa font-white bg-hover-white socicon-coderwall tooltips" data-original-title="Coderwall"></a>
            <a href="#" class="socicon-btn socicon-btn-circle socicon-sm socicon-solid bg-red bg-hover-grey-salsa font-white bg-hover-white socicon-tripadvisor tooltips" data-original-title="Tripadvisor"></a>
            <a href="#" class="socicon-btn socicon-btn-circle socicon-sm socicon-solid bg-green bg-hover-grey-salsa font-white bg-hover-white socicon-appnet tooltips" data-original-title="Appnet"></a>
            ...
            <a href="#" class="socicon-btn socicon-btn-circle socicon-sm socicon-solid bg-yellow bg-hover-grey-salsa font-white bg-hover-white socicon-tripit tooltips" data-original-title="Tripit"></a>
            ...
            <a href="#" class="socicon-btn socicon-btn-circle socicon-sm socicon-solid bg-red bg-hover-grey-salsa font-white bg-hover-white socicon-slideshare tooltips" data-original-title="Slideshare"></a>
            <a href="#" class="socicon-btn socicon-btn-circle socicon-sm socicon-solid bg-red bg-hover-grey-salsa font-white bg-hover-white socicon-buffer tooltips" data-original-title="Buffer"></a>
            <a href="#" class="socicon-btn socicon-btn-circle socicon-sm socicon-solid bg-yellow bg-hover-grey-salsa font-white bg-hover-white socicon-rss tooltips" data-original-title="Rss"></a>
            ...
            <a href="#" class="socicon-btn socicon-btn-circle socicon-sm socicon-solid bg-green bg-hover-grey-salsa font-white bg-hover-white socicon-houzz tooltips" data-original-title="Houzz"></a>
            <a href="#" class="socicon-btn socicon-btn-circle socicon-sm socicon-solid bg-yellow bg-hover-grey-salsa font-white bg-hover-white socicon-mail tooltips" data-original-title="Mail"></a>
            ...
            <a href="#" class="socicon-btn socicon-btn-circle socicon-sm socicon-solid bg-dark bg-hover-grey-salsa font-white bg-hover-white socicon-smugmug tooltips" data-original-title="Smugmug"></a>
            <a href="#" class="socicon-btn socicon-btn-circle socicon-sm socicon-solid bg-green bg-hover-grey-salsa font-white bg-hover-white socicon-swarm tooltips" data-original-title="Swarm"></a>
            <a href="#" class="socicon-btn socicon-btn-circle socicon-sm socicon-solid bg-blue bg-hover-grey-salsa font-white bg-hover-white socicon-triplej tooltips" data-original-title="Triplej"></a>
            <a href="#" class="socicon-btn socicon-btn-circle socicon-sm socicon-solid bg-blue bg-hover-grey-salsa font-white bg-hover-white socicon-yammer tooltips" data-original-title="Yammer"></a>
            <a href="#" class="socicon-btn socicon-btn-circle socicon-sm socicon-solid bg-red bg-hover-grey-salsa font-white bg-hover-white socicon-stackoverflow tooltips" data-original-title="Stackoverflow"></a>
            ...
            <a href="#" class="socicon-btn socicon-btn-circle socicon-sm socicon-solid bg-green bg-hover-grey-salsa font-white bg-hover-white socicon-odnoklassniki tooltips" data-original-title="Odnoklassniki"></a>
            <a href="#" class="socicon-btn socicon-btn-circle socicon-sm socicon-solid bg-green bg-hover-grey-salsa font-white bg-hover-white socicon-android tooltips" data-original-title="Android"></a>
            ...
            <a href="#" class="socicon-btn socicon-btn-circle socicon-sm socicon-solid bg-dark bg-hover-grey-salsa font-white bg-hover-white socicon-persona tooltips" data-original-title="Persona"></a>
        </div>
    </div>
</div>
