...
<body>
<!-- BEGIN PAGE TITLE-->
<h3 class="page-title"> Tiles
    <small>windows8风格的页面贴片</small>
</h3>
<!-- END PAGE TITLE-->
<!-- END PAGE HEADER-->
    ...
    <div class="portlet-body">
        <div class="tiles">
            ...
            <div class="tile double bg-blue-madison">
                <div class="tile-body">
                    <img src="/theme/assets/pages/media/profile/photo1.jpg" alt="">
                    <h4>Announcements</h4>
            ...
            <div class="tile image selected">
                <div class="tile-body">
                    <img src="/theme/assets/pages/media/gallery/image2.jpg" alt=""> </div>
                <div class="tile-object">
            ...
            <div class="tile double bg-grey-cascade">
                <div class="tile-body">
                    <img src="/theme/assets/pages/media/profile/photo2.jpg" alt="" class="pull-right">
                    <h3>@lisa_wong</h3>
            ...
            <div class="tile image double selected">
                <div class="tile-body">
                    <img src="/theme/assets/pages/media/gallery/image4.jpg" alt=""> </div>
                <div class="tile-object">
