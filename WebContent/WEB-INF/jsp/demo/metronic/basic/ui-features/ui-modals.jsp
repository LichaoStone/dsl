...
<div class="row">
	<div class="col-md-12">
		<div class="note note-success note-bordered">
			...
			<p>
		    	插件的css与js:<br>
		    	<a href="/theme/assets/global/plugins/jquery-ui/jquery-ui.js" target="_blank">
		    		global/plugins/jquery-ui/jquery-ui.min.js
		    	</a>
			</p><br>
			<p>
				本demo页面的js:<br>
				<a href="/theme/assets/pages/scripts/ui-modals.js" target="_blank">
					pages/scripts/ui-modals.js
				</a>
		    </p><br>
		    <p> 模态框扩展：
		        <a href="/lambo/demo/metronic/basic/ui-features/ui-extend-modals" target="_blank">模态框扩展</a>
		    </p>
		</div>
	</div>
</div>
