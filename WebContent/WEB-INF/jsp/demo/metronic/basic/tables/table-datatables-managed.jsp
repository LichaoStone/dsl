...
<html>
<head>
<title>Managed datatables</title>
</head>
<body>
<lambo:link path="global/plugins/datatables/datatables.css,
				  global/plugins/datatables/plugins/bootstrap/datatables.bootstrap.css" />
<!-- BEGIN PAGE TITLE-->
<h3 class="page-title"> 普通 Datatables
    <small>普通 datatable示例</small>
</h3>
<!-- END PAGE TITLE-->
<!-- END PAGE HEADER-->
<!-- BEGIN PAGE BANNER-->
<div class="row">
	<div class="col-md-12">
		<div class="note note-success note-bordered">
			<p>
				用途：DataTables是一个高度灵活易用的jquery插件，而且他在不断更新，将来能适应任何html表格
			</p>
			<br>
			<p>
		    	插件的css与js:<br>
			...
			<p>
				本demo页面的js:<br>
				<a target="_blank" href = "/theme/assets/pages/scripts/table-datatables-managed.js">
							pages/scripts/table-datatables-managed.js
				</a><br>
		    </p><br>
		    <p> 更多资料：
		        <a href="http://datatables.net/" target="_blank">官方文档</a>
		    </p>
		</div>
	</div>
</div>
