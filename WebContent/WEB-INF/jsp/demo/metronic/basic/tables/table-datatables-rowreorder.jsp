...
<html>
<head>
<title>Rowreorder datatables</title>
</head>
<body>
<lambo:link path="global/plugins/datatables/datatables.css,
				  global/plugins/datatables/plugins/bootstrap/datatables.bootstrap.css" />
<!-- BEGIN PAGE TITLE-->
<h3 class="page-title"> Rowreorder Extension
...
<div class="row">
	<div class="col-md-12">
		<div class="note note-success note-bordered">
			<p>
				用途：RowReorder扩展了表格行的功能，允许用户通过点击并且拖拽行，来给表格重新手动排序
			</p>
			<br>
			<p>
		    	插件的css与js:<br>
			...
			<p>
				本demo页面的js:<br>
				<a target="_blank" href = "/theme/assets/pages/scripts/table-datatables-rowreorder.js">
							pages/scripts/table-datatables-rowreorder.js
				</a><br>
		    </p><br>
		    <p> 更多资料：
		        <a href="http://datatables.net/extensions/rowreorder" target="_blank">官方文档</a>
		    </p>
		</div>
	</div>
</div>
