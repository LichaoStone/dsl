...
<html>
<head>
<title>Responsive datatables</title>
</head>
<body>
<lambo:link
...
<div class="row">
	<div class="col-md-12">
		<div class="note note-success note-bordered">
			<p>
				用途：响应式的扩展功能，可以在不大小的窗口下，动态插入或者删除列，来优化表格的展示
			</p>
			<br>
			<p>
		    	插件的css与js:<br>
			...
			<p>
				本demo页面的js:<br>
				<a target="_blank" href = "/theme/assets/pages/scripts/table-datatables-responsive.js">
							pages/scripts/table-datatables-responsive.js
				</a><br>
		    </p><br>
		    <p> 更多资料：
		        <a href="https://www.datatables.net/extensions/responsive/" target="_blank">官方文档</a>
		    </p>
		</div>
	</div>
</div>
