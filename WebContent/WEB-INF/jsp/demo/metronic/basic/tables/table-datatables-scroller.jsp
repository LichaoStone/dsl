...
<html>
<head>
<title>Scroller datatables</title>
</head>
<body>
<lambo:link path="global/plugins/datatables/datatables.css,
				  global/plugins/datatables/plugins/bootstrap/datatables.bootstrap.css" />
<!-- BEGIN PAGE TITLE-->
<h3 class="page-title"> Scroller Extension
    <small>带滚表条表格示例</small>
</h3>
<!-- END PAGE TITLE-->
<!-- END PAGE HEADER-->
<!-- BEGIN PAGE BANNER-->
<div class="row">
	<div class="col-md-12">
		<div class="note note-success note-bordered">
			<p>
				用途：Scroller是DataTables在展示大量数据集时候的一种虚拟处理方式，每次只加载用户视觉行数之内的数据。随着拖拽滚动条，不断的加载用户视觉范围内的数据，
				给用户造成一种整个表格都是可见的效果。
			</p>
			<br>
			<p>
			...
			<p>
				本demo页面的js:<br>
				<a target="_blank" href = "/theme/assets/pages/scripts/table-datatables-scroller.js">
							pages/scripts/table-datatables-scroller.js
				</a><br>
		    </p><br>
		    <p> 更多资料：
		        <a href="http://datatables.net/extensions/scroller/" target="_blank">官方文档</a>
		    </p>
		</div>
	</div>
</div>
