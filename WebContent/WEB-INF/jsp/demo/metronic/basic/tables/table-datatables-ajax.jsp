	...
	<div class="col-md-12">
		<div class="note note-success note-bordered">
			...
			<p>
			 ...
			 <p>
				本demo页面的js:<br>
				<a target="_blank" href = "/theme/assets/pages/scripts/table-datatables-ajax.js">
					pages/scripts/table-datatables-ajax.js
				</a><br>
			</p>
		</div>
	</div>
...
<lambo:script path="global/scripts/datatable.js,
					...
					global/plugins/datatables/plugins/bootstrap/datatables.bootstrap.js,
					global/plugins/bootstrap-datepicker/js/bootstrap-datepicker.js" />
<lambo:script path="pages/scripts/table-datatables-ajax.js" />
</body>