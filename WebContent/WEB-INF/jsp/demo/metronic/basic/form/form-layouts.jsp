...
<div class="row">
	<div class="col-md-12">
		<div class="note note-success note-bordered">
			...
			<p>
				本demo页面的js:<br>
				<a target="_blank" href = "/theme/assets/pages/scripts/form-samples.js">
				pages/scripts/form-samples.js
				</a>
		    </p>
		</div>
	</div>
...
<lambo:script path="pages/scripts/form-samples.js" />
</body>