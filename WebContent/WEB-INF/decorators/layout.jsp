...
<html lang="en">
    ...
    <head>
        ...
        layouts/layout/css/layout.css,layouts/layout/css/themes/default.css,
    ...
    <body class="page-sidebar-closed-hide-logo page-content-white page-header-fixed page-sidebar-fixed">
                    ...
                    <ul class="nav navbar-nav pull-right">
                        ...
                        <li class="dropdown dropdown-user">
                            <a href="javascript:;" class="dropdown-toggle" data-toggle="dropdown" data-hover="dropdown" data-close-others="true">
                                <span class="username username-hide-on-mobile"> 测试账号 </span>
		...
		<lambo:script path="global/scripts/menu.js" />
