...
$.extend(true, $.fn.dataTable.defaults, {
    "dom": "<'row headbar'<'col-md-6 col-sm-6'f><'col-md-6 col-sm-6'B>r><'table-scrollable't><'row footbar'<'col-md-5 col-sm-5'i l><'col-md-7 col-sm-7'p>>", // default layout with horizobtal scrollable datatable
    ...
    "bootstrap_extended": {
        "fnInit": function (oSettings, nPaging, fnDraw) {
            ...
            $(nPaging).append(
                ...
                '<span class="pagination-panel-info">共<span class="pagination-panel-total"></span>页</span>' + 
